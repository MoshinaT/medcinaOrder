...
import AddProductBatch from './admin/AddProductBatch';
  ...
  return (
    <BrowserRouter>
      <Switch>
        ...
        <AdminRoute path='/create/productBatch' component={AddProductBatch} exact />
        <Route path='/product/:productId' component={Product} exact />
        <Route path='/cart' component={Cart} exact />
        <AdminRoute path='/admin/orders' component={Orders} exact />
        <AdminRoute path='/admin/vieworders/:orderId' component={ViewOrders} exact />
